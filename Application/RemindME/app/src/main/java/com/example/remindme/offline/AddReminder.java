...
public class AddReminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextInputEditText nameField = binding.name;
        final TextInputEditText medDesc = binding.desc;
        final TextInputEditText txtDate = binding.date;
        final TextInputEditText txtTime = binding.time;
        ...
        binding.addReminder.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(name)) {
                ...
                if (System.currentTimeMillis() > mCalendar.getTimeInMillis()) {
                    ...
                    Reminders reminder = new Reminders(name, desc, date, time, String.valueOf(isRepeating));
                    mDatabase.addReminder(reminder);
