...
public class RegisterActivity extends AppCompatActivity {
    ...
    // Email Validation https://stackoverflow.com/questions/12947620/email-address-validation-in-android-on-edittext
    ...
    private void registerMe() {
        ...
        if (!isValidEmail(email)) {
            binding.emailField.setError("Invalid email format");
