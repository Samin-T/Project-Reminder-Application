...
public class EditOnlineReminder extends AppCompatActivity {
    private final String URL_ADD = "http://192.168.0.81/remindme/api/editreminder.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addReminder.setOnClickListener(view -> {
            ...
            if (System.currentTimeMillis() > mCalendar.getTimeInMillis()) {
                ...
                editReminder(name, desc, date, time, String.valueOf(isRepeating), editMedID);
            }
        });
    ...
    // Edit Reminder
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void editReminder(String medName, String medDesc, String medDate, String medTime, String isRepeating, int editMedID) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ADD,
                response -> {
                    ...
                    try {
                        ...
                        if (jsonObject.optString("status").equals("true")) {
                            ...
                            //Toast.makeText(EditOnlineReminder.this, "Reminder set", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(EditOnlineReminder.this, MainActivity.class);
                            startActivity(intent);
                            this.finish();
                        } else {
                            Toast.makeText(EditOnlineReminder.this, "Error", Toast.LENGTH_SHORT).show();
                        }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("ID", Integer.toString(editMedID));
                return params;
            }
        };
        requestQueue = Volley.newRequestQueue(EditOnlineReminder.this);
